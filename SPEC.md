...
- 디바이스 크기: 뷰포트 면적의 25~35% 범위. 스니펫 배치 후 시각적 균형을 보고 조정.
...
- 동시 표시: 2~3개.
- 배치: 디바이스 중심으로 방사형 분포. 6~8개 존 정의. Cosmos처럼 뷰포트 사분면에 고르게, 약간의 비대칭. 한쪽에 몰리지 않는다.
- 총 스니펫 수: 8~10개 준비, 6~8개 사용. time-based로 각 존에 fade in → 유지 → fade out 순환.
- 스니펫 크기와 목업 크기의 비율: Cosmos 이미지 카드 대비 1/4~1/5 수준 참고. 전체 레이아웃 설계 후 조정.
...
맥락 기억:
4. "무릎은 좀 나아지셨어요? 저번에 많이 아프셨잖아요." (2줄)
5. "손주 시험 잘 봤다면서요?" (1줄)
6. "지난번에 좋아하신다던 그 노래, 찾아뒀어요." (2줄)

관계 진화:
7. "요즘 기운이 없어 보이세요. 무슨 일 있으신 건 아니죠?" (2줄)
8. "그럴 수 있어요. 너무 속상해 마세요." (1줄)

일상 동반:
9. "오후 2시쯤에는 좀 따뜻해질 거예요." (1줄)
10. "내일 비 온대요. 빨래는 오늘 하시는 게 좋겠어요." (2줄)
...
- 섹션 진입(whileInView onEnter) → 단일 GSAP timeline 자동 재생:
  ...
  2. 스니펫 순환 (~12s): stagger로 각 존에 fade in → 유지 → fade out
